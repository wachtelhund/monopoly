...
public class TierOneTests {
  ...
  public void tileConstructionTest_2() {
    ...
    // (2) <- 1 <-> 2 -> (1)
    assertEquals(sut2, sut1.getNext(),
        "Link to sut1 next tile not set correctly");
    assertEquals(sut2, sut1.getPrev(),
        "Link to sut1 prev tile not set correctly");
    assertEquals(sut1, sut2.getPrev(),
        "Link to sut2 prev tile not set correctly");
    assertEquals(sut1, sut2.getNext(),
        "Link to sut2 next tile not set correctly");
  }
  ...
  public void tileConstructionTest_3() {
    ...
    // the list should look like this
    // (3) <- 1 <-> 2 <-> 3 -> (1)
    assertEquals(sut1, sut3.getNext(),
        "Link to sut3 next tile not set correctly");
    assertEquals(sut2, sut3.getPrev(),
        "Link to sut3 prev tile not set correctly");
    assertEquals(sut1, sut2.getPrev(),
        "Link to sut2 prev tile not set correctly");
  }
  ...
  public void tileConstructionTest_4() {
    ...
    // (2) <- 1 <-> 3 <-> 2 -> (1)
    assertEquals(sut2, sut3.getNext(),
        "Link to sut3 next tile not set correctly");
    assertEquals(sut1, sut3.getPrev(),
        "Link to sut3 prev tile not set correctly");
    assertEquals(sut3, sut1.getNext(),
        "Link to sut1 prev tile not set correctly");
    assertEquals(sut2, sut1.getPrev(),
        "Link to sut1 prev tile not set correctly");
    assertEquals(sut3, sut2.getPrev(),
        "Link to sut2 prev tile not set correctly");
    assertEquals(sut1, sut2.getNext(),
        "Link to sut2 prev tile not set correctly");
  }
  ...
  public void tileConstructionTest_5() {
    ...
    assertEquals(sut1, sut2.getNext(),
        "Link to sut2 next tile not set correctly");
    assertEquals(sut1, sut4.getPrev(),
        "Link to sut4 prev tile not set correctly");
    assertEquals(sut3, sut2.getPrev(),
        "Link to sut2 prev tile not set correctly");
    assertEquals(sut3, sut4.getNext(),
        "Link to sut4 prev tile not set correctly");
    assertEquals(sut4, sut1.getNext(),
        "Link to sut1 next tile not set correctly");
    assertEquals(sut4, sut3.getPrev(),
        "Link to sut3 prev tile not set correctly");
  }
  ...
  public void tileConstructiontest_6() {
    ...
    for (int i = 0; i < nodeCount; i++) {
      ...
      assertEquals(start, nNew.getNext(), "tile" + i +
          ".next is not correctly set to start");
      assertEquals(n, nNew.getPrev(), "tile" + i +
          ".prev is not correctly set to tile" + (i - 1));
